...
#' @param path_to_input_reference_database String specifying path to input reference database in FASTA format (with '.fasta' extension).
#' @param path_to_output_BLAST_database String specifying path to output BLAST database in FASTA format (with '.fasta' extension). File path cannot contain spaces.
